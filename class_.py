...
class DatabaseManager:
    ...
    def create_produit(self, nom, prix, quantite, id_categorie, description):
        query = "INSERT INTO produit (nom, description, prix, quantite, id_categorie) VALUES (%s, %s, %s, %s, %s)"
        values = (nom, prix, quantite, id_categorie, description)
    ...
    def update_produit(self, produit_id, nom=None, prix=None, quantite=None, id_categorie=None, description=None):
